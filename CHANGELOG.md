...
## [0.7.0] — 2026-05-06
### Added
- TIP 페이지: 25개 용어 사전 전체 구현 (기본 5 · 제품 기능 5 · 연결 4 · 자동화 11)
- TIP 페이지: 실시간 검색 + 카테고리 탭 필터 (tip-filter.js)
- TIP 페이지: 각 카드 — 한 줄 정의 · 비유 · disclosure(기술 상세) · 제품 페이지 링크
- 용어 툴팁: TIP 링크 경로 수정 — 모든 페이지 깊이에서 정확한 앵커 이동 (tip/#tip-{id})
- `.claude/prd.md`: P1 비개발자 · P2 개발자 · P3 중간 사용자 공식 페르소나 정의
- `.claude/rules/workflow.md`: 페르소나 체크 항목 추가
### Fixed
- reset.css `[hidden]` 규칙 추가 — CSS display 충돌로 hidden 속성이 무시되던 문제 해결
